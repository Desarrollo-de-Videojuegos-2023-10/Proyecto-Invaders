...
class WinScene(Scene):
    ...
    def do_create(self):
        create_text(self.ecs_world, "YOU COMPLETED THE LEVEL!", 8,
                    pygame.Color(255, 0, 0), pygame.Vector2(128, 130), TextAlignment.CENTER)
        create_text(self.ecs_world, "PRESS Z TO TRY AGAIN", 7,
                    pygame.Color(255, 255, 0), pygame.Vector2(128, 150), TextAlignment.CENTER)
        create_text(self.ecs_world, "PRESS ESC TO GO TO THE MAIN MENU", 7,
                    pygame.Color(255, 255, 0), pygame.Vector2(128, 180), TextAlignment.CENTER)
